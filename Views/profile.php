...
<?php if (isset($_GET['user_id'])) : ?>
    ...
    <!-- 自分のページ -->
        ...
        <?php endif; ?>
                ...
                <div class="modal fade" id="js-modal" tabidex="-1" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form action="profile.php" method="post" enctype="multipart/form-data">
                                <div class="modal-header">
                                    <h5 class="modal-tittle">プロフィールを編集</h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" class="form-conrol form-control-sm" name="image">
                                    </div>

                                    
                                    <input type="text" class="form-control mb-4" value="太朗" name="nickname" placeholder="ニックネ－ム" maxlength="50" required>
                                    <input type="text" class="form-control mb-4" value="taro" name="name" placeholder="ユーザー名" maxlength="50" required>
                                    <input type="email" class="form-control mb-4" value="taro@techis.jp" name="email" placeholder="メールアドレス" maxlength="254" required>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <div class="btn" type="submit">保存する</div>
                                </div>
                            </form>
                        </div>
                    </div>
