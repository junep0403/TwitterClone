...
$view_tweets = [
    [
        ...
        'tweet_created_at' => '2022-05-13 14:00:00',
        'like_id' => null,
        'like_count' => 0,
    ],
    [
 ...
 *  @return string
 */
function buildingImagePath(string $name = null, string $type)
{
 ...
 * 
 *  @param string $daytime 日時
 *  @return string
 */

function convertToDayTimeAgo(string $daytime)
{
    $unix = strtotime($daytime);
    $now = time();
    $diff_sec = $now - $unix;
            ...
            <div class="input-area">
                <form action="post.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="bottom-area">
                        <div class="mb-0">
                            <input type="file" name="image" class="from-control form-control-sm">
                        </div>
                ...
                <div class="tweet">
                    <div class="user">
                        <a href="profile.php?user_id = <?php echo htmlspecialchars($view_tweet['user_id']); ?> ">
                            <img src="<?php echo buildingImagePath($view_tweet['user_image_name'], 'user'); ?>" alt="">
                        </a>
                    </div>
                    <div class="content">
                        <div class="name">
                        ...
                        <img src="<?php echo buildingImagePath($view_tweet['tweet_image_name'], 'tweet');?>" alt="" class="post-image">
                        <?php endif; ?>
